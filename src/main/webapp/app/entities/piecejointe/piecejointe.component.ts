...
piecejointes: Piecejointe[];
    ...
    loadAll() {
        this.piecejointeService.query().subscribe(
            (res: ResponseWrapper) => {
                this.piecejointes = res.json;
            },
    ...
    registerChangeInPiecejointes() {
        this.eventSubscriber = this.eventManager.subscribe('piecejointeListModification', (response) => this.loadAll());
    }
